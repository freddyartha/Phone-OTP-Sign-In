...
class _InputTextState extends State<InputTextComponent> {
  ...
  Widget addButton(bool isAdd) {
    return Visibility(
      visible: widget.editable,
      child: Container(
        margin: EdgeInsets.only(left: isAdd ? 10 : 0, right: isAdd ? 0 : 10),
        child: ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            ...
            backgroundColor: MahasColors.warning,
          ),
          child: Icon(
            isAdd ? FontAwesomeIcons.plus : FontAwesomeIcons.minus,
            size: 14,
          ),
        ),
      ),
  ...
  Widget build(BuildContext context) {
    ...
    return Visibility(
      ...
      child: InputBoxComponent(
        ...
        children: widget.controller.addButton
            ? Row(
                children: [
                  addButton(false),
                  Expanded(
